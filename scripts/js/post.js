...
document.getElementsByClassName("author-name")[0].innerHTML = document.cookie.split('=')[1];
document.getElementsByClassName("post-title")[0].innerHTML = localStorage.title;
